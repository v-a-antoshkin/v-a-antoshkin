...
class MyPublicationsSection1 extends BaseElement {
    ...
    static get styles() {
        return [
            ...
            css`
                ...
                .writer-image {
                    background: url("images/my-publications/writer-left.jpg") 50% center / cover no-repeat;
                    border-radius: 50%;
                    grid-area: 3 / 8 / 12 / 15;
                }
    ...
    render() {
        return html`
            <div class="container">
                ...
                <div class="circle-image" @click=${this.publicationClick}>${publications.length}</div>
                <div class="container-layout-1">
                    <h2>I'm a good writer</h2>
                    <h1>Writing for mental alertness</h1>
                    <p>All my <a href="https://www.elibrary.ru/author_items.asp?authorid=261293" target="_blank">publications</a>
                    </p>
                </div>
            </div>
        `;
...
customElements.define("my-publications-section-1", MyPublicationsSection1);